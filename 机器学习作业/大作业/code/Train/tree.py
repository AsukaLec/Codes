...
models = {
    ...
    'ExtraTrees': ExtraTreesClassifier(n_estimators=100, max_depth=None, random_state=42)
}

# 3. 5 折分层交叉验证
cv = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
out_dir = Path('机器学习作业/大作业/image/tree_baseline/')
...
print('\n树模型 baseline 完成！图已保存 → image/tree_baseline/')
