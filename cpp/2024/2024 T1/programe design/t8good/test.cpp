...
// using namespace std;
// int main(){
//     char *p[2][3]={"abc","defg","hi","jklmnop","qrstuvwxyz","ABCD"};
//     cout<<p[1]<<" "<<*(p+1)<<" "<<(*(*(p+1)+1));
//     //(*(*(p+1)+1))
//     //*(p+1)+1<<" "<<*(p+1)+2;
// }
...
private:
	...
	short stocknum;
public:
	StockExchange(short n=10,const string &na="上海证券交易所") : stockmax(n), boursename(na), stocknum(0)	
	{
