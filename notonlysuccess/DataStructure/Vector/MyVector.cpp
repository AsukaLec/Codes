...
int main(){
    // MyVector<int> vec {1, 1, 4, 5, 1, 4};
    // cout << vec.capacity() << endl;
    // vec.push_back(7);
    // cout << vec.capacity() << endl;
    // vec.resize(10, 114514); // 输出1 2 3 初始值已有，就不是0咯
    ...
    // // cout << lower_bound(vec.begin(), vec.end(), 1234) - vec.begin() << endl;
    // for (auto &x : vec) { // 支持 .begin() .end() ++ != * 就可使用范围循环
    //     cout << x << ' ';
    // }
